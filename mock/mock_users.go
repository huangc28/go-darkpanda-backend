...
// Source: internal/app/contracts/users.go
...
func (m *MockUserDAOer) GetUserByUsername(username string, fields ...string) (*models.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDAOerMockRecorder) GetUserByUsername(username interface{}, fields ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{username}, fields...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByUsername", reflect.TypeOf((*MockUserDAOer)(nil).GetUserByUsername), varargs...)
}

// UpdateUserInfoByUuid mocks base method
func (m *MockUserDAOer) UpdateUserInfoByUuid(p contracts.UpdateUserInfoParams) (*models.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserInfoByUuid", p)
	ret0, _ := ret[0].(*models.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserDAOerMockRecorder) UpdateUserInfoByUuid(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserInfoByUuid", reflect.TypeOf((*MockUserDAOer)(nil).UpdateUserInfoByUuid), p)
}
...
// DeleteUserImages mocks base method
func (m *MockUserDAOer) DeleteUserImages(url string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUserImages", url)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteUserImages indicates an expected call of DeleteUserImages
func (mr *MockUserDAOerMockRecorder) DeleteUserImages(url interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUserImages", reflect.TypeOf((*MockUserDAOer)(nil).DeleteUserImages), url)
}
