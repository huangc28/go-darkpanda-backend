...
// The GroupUsersQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type GroupUsersQueryRuleFunc func(context.Context, *ent.GroupUsersQuery) error

// EvalQuery return f(ctx, q).
func (f GroupUsersQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.GroupUsersQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.GroupUsersQuery", q)
}

// The GroupUsersMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type GroupUsersMutationRuleFunc func(context.Context, *ent.GroupUsersMutation) error

// EvalMutation calls f(ctx, m).
func (f GroupUsersMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.GroupUsersMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.GroupUsersMutation", m)
}
...
// The UserRefCodesQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type UserRefCodesQueryRuleFunc func(context.Context, *ent.UserRefCodesQuery) error

// EvalQuery return f(ctx, q).
func (f UserRefCodesQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserRefCodesQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.UserRefCodesQuery", q)
}

// The UserRefCodesMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type UserRefCodesMutationRuleFunc func(context.Context, *ent.UserRefCodesMutation) error

// EvalMutation calls f(ctx, m).
func (f UserRefCodesMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.UserRefCodesMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.UserRefCodesMutation", m)
}
