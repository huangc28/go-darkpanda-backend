...
func (u *User) assignValues(values ...interface{}) error {
	...
	if value, ok := values[2].(*sql.NullBool); !ok {
		return fmt.Errorf("unexpected type %T for field marital_status", values[2])
	} else if value.Valid {
		u.MaritalStatus = value.Bool
	}
	return nil
}
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.MaritalStatus))
	builder.WriteByte(')')
